...
# !
# Правильно. Ви гарно впорались із рекурсивною функцією. 
# Якщо Ви використовуєте сторонні бібліотеки - створюйте файл requirements.txt зі всіми необхідними залежностями.
